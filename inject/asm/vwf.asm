...
.org 0x087c7870
ops_remainder_1:
    .db LEN_1BITS,POS_4,OP_SUB,0x3E,LSR_0,LEN_3BITS,POS_1,OP_ADD,0x3E,LSR_1,INC_COUNTERs_0x1 ; 0
    .db LEN_1BITS,POS_1,JUST_INSERT,0x0,LSR_0,LEN_3BITS,POS_2,OP_ADD,0x2,INC_COUNTERs_0x1 ; 1
    .db LEN_1BITS,POS_1,OP_SUB,0x3C,LSR_0,LEN_3BITS,POS_2,OP_ADD,0x3E,LSR_1,INC_COUNTERs_0x1 ; 0
    .db LEN_1BITS,POS_1,JUST_INSERT,LSR_0,0x0,LEN_3BITS,POS_2,OP_ADD,0x2,LSR_0,INC_COUNTERs_0x1 ; 1
	
    .db LEN_1BITS,POS_4,OP_SUB,0x3C,LSR_0,LEN_3BITS,POS_1,OP_ADD,0x3E,LSR_1,INC_COUNTERs_0x1 ; 0
    .db LEN_1BITS,POS_1,JUST_INSERT,0x0,LSR_0,LEN_3BITS,POS_2,OP_ADD,0x2,INC_COUNTERs_0x1 ; 1
    .db LEN_1BITS,POS_1,OP_SUB,0x3C,LSR_0,LEN_3BITS,POS_2,OP_ADD,0x3E,LSR_1,INC_COUNTERs_0x1 ; 0
    .db LEN_1BITS,POS_1,JUST_INSERT,LSR_0,0x0,LEN_3BITS,POS_2,OP_ADD,0x2,LSR_0,INC_COUNTERs_0x1 ; 1
	
	.db LEN_0BITS,POS_0,OP_ADD,0x02,LSR_0,LEN_0BITS,POS_0,JUST_INSERT,0x00,LSR_0,SKIP_COUNTERs_0x0 ; 4
